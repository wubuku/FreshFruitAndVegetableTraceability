...
public class PersonResource {
    ...
    public PersonStateDto[] getAll( HttpServletRequest request,
    ...
    /**
     * Retrieve in pages.
     * Retrieve People in pages.
     */
    @GetMapping("_page")
    @Transactional(readOnly = true)
    public Page<PersonStateDto> getPage( HttpServletRequest request,
                    @RequestParam(value = "fields", required = false) String fields,
        ...
        try {
            ...
            states = partyApplicationService.get(PersonState.class, 
                ...
                PersonResourceUtils.getQuerySorts(request.getParameterMap()),
                firstResult, maxResults);
            long count = partyApplicationService.getCount(PersonState.class, c);
            ...
            Page.PageImpl<PersonStateDto> statePage =  new Page.PageImpl<>(dtoConverter.toPersonStateDtoList(states), count);
    ...
    @GetMapping("{partyId}")
    @Transactional(readOnly = true)
    public PersonStateDto get(@PathVariable("partyId") String partyId, @RequestParam(value = "fields", required = false) String fields) {
        try {
    ...
    public String post(@RequestBody CreateOrMergePatchPartyDto.CreatePartyDto value,  HttpServletResponse response) {
        try {
            value.setPartyTypeId(PartyTypeId.PERSON);
    ...
    public void delete(@PathVariable("partyId") String partyId,
        ...
        try {
            ...
            deleteCmd.setPartyTypeId(PartyTypeId.PERSON);
    ...
    @Transactional(readOnly = true)
    public PersonStateDto getHistoryState(@PathVariable("partyId") String partyId, @PathVariable("version") long version, @RequestParam(value = "fields", required = false) String fields) {
        try {
            ...
            return dtoConverter.toPersonStateDto(partyApplicationService.getHistoryState(idObj, version));
    ...
    public PartyIdentificationStateDto[] getPartyIdentifications(@PathVariable("partyId") String partyId,
        ...
        try {
            ...
            if (!StringHelper.isNullOrEmpty(filter)) {
                ...
                criterion = QueryParamUtils.getQueryCriterionDto(request.getParameterMap().entrySet().stream()
                    .filter(kv -> PersonResourceUtils.getPartyIdentificationFilterPropertyName(kv.getKey()) != null)
                    .collect(Collectors.toMap(kv -> kv.getKey(), kv -> kv.getValue())));
            }
            Criterion c = CriterionDto.toSubclass(criterion, getCriterionTypeConverter(), getPropertyTypeResolver(), 
            ...
            Iterable<PartyIdentificationState> states = partyApplicationService.getPartyIdentifications(partyId, c,
                    PersonResourceUtils.getPartyIdentificationQuerySorts(request.getParameterMap()));
    ...
    protected PropertyTypeResolver getPartyIdentificationPropertyTypeResolver() {
        return new PropertyTypeResolver() {
            @Override
            public Class resolveTypeByPropertyName(String propertyName) {
                return PersonResourceUtils.getPartyIdentificationFilterPropertyType(propertyName);
            }
        };
    }
