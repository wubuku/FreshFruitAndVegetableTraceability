...
public interface ProductTypeStateQueryRepository {
    ...
    ProductTypeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders);

    ProductTypeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders);
