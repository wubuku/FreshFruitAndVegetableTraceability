...
import org.dddml.ffvtraceability.domain.party.InformalOrganizationEvent.*;

public abstract class AbstractInformalOrganizationState extends AbstractOrganizationState implements InformalOrganizationState.SqlInformalOrganizationState, Saveable {

    public AbstractInformalOrganizationState(List<Event> events) {
    ...
    public AbstractInformalOrganizationState() {
    ...
    public void mutate(Event e) {
        ...
        if (e instanceof InformalOrganizationStateCreated) {
            when((InformalOrganizationStateCreated) e);
        } else if (e instanceof InformalOrganizationStateMergePatched) {
            when((InformalOrganizationStateMergePatched) e);
        } else if (e instanceof InformalOrganizationStateDeleted) {
            when((InformalOrganizationStateDeleted) e);
    ...
    public void when(InformalOrganizationStateCreated e) {
        throwOnWrongEvent(e);
    ...
    public void merge(PartyState s) {
        merge((InformalOrganizationState)s);
    }

    public void merge(InformalOrganizationState s) {
        if (s == this) {
            return;
        }
    ...
    public void when(InformalOrganizationStateMergePatched e) {
        throwOnWrongEvent(e);
    ...
    public void when(InformalOrganizationStateDeleted e) {
        throwOnWrongEvent(e);
