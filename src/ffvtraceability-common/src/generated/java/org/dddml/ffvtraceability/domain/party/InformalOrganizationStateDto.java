...
public class InformalOrganizationStateDto extends OrganizationStateDto {
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public InformalOrganizationStateDto[] toInformalOrganizationStateDtoArray(Iterable<PartyState> states) {
            return toInformalOrganizationStateDtoList(states).toArray(new InformalOrganizationStateDto[0]);
        }

        public List<InformalOrganizationStateDto> toInformalOrganizationStateDtoList(Iterable<PartyState> states) {
            ArrayList<InformalOrganizationStateDto> stateDtos = new ArrayList();
            for (PartyState s : states) {
                InformalOrganizationStateDto dto = toInformalOrganizationStateDto(s);
                stateDtos.add(dto);
            }
            return stateDtos;
        }

        public InformalOrganizationStateDto toInformalOrganizationStateDto(PartyState state)
        {
            if(state == null) {
                return null;
            }
