...
public abstract class AbstractPartyIdentificationTypeCommand extends AbstractCommand implements PartyIdentificationTypeCommand {
    ...
    public static abstract class AbstractCreatePartyIdentificationType extends AbstractCreateOrMergePatchPartyIdentificationType implements CreatePartyIdentificationType
    {
        @Override
    ...
    public static abstract class AbstractMergePatchPartyIdentificationType extends AbstractCreateOrMergePatchPartyIdentificationType implements MergePatchPartyIdentificationType
    {
        @Override
        public String getCommandType() {
    ...
    public static class SimpleCreatePartyIdentificationType extends AbstractCreatePartyIdentificationType
    {
    }

    
    public static class SimpleMergePatchPartyIdentificationType extends AbstractMergePatchPartyIdentificationType
    {
    }

    
    public static class SimpleDeletePartyIdentificationType extends AbstractPartyIdentificationTypeCommand implements DeletePartyIdentificationType
    {
        @Override
        public String getCommandType() {
