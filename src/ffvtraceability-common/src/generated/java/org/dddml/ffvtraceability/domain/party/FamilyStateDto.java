...
public class FamilyStateDto extends InformalOrganizationStateDto {
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public FamilyStateDto[] toFamilyStateDtoArray(Iterable<PartyState> states) {
            return toFamilyStateDtoList(states).toArray(new FamilyStateDto[0]);
        }

        public List<FamilyStateDto> toFamilyStateDtoList(Iterable<PartyState> states) {
            ArrayList<FamilyStateDto> stateDtos = new ArrayList();
            for (PartyState s : states) {
                FamilyStateDto dto = toFamilyStateDto(s);
                stateDtos.add(dto);
            }
            return stateDtos;
        }

        public FamilyStateDto toFamilyStateDto(PartyState state)
        {
            if(state == null) {
                return null;
            }
