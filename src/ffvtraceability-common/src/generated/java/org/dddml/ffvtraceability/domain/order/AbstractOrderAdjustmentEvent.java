...
public abstract class AbstractOrderAdjustmentEvent extends AbstractEvent implements OrderAdjustmentEvent.SqlOrderAdjustmentEvent {
    private OrderAdjustmentEventId orderAdjustmentEventId = new OrderAdjustmentEventId();

    public OrderAdjustmentEventId getOrderAdjustmentEventId() {
        return this.orderAdjustmentEventId;
    }

    public void setOrderAdjustmentEventId(OrderAdjustmentEventId eventId) {
        this.orderAdjustmentEventId = eventId;
    }
    
    public String getOrderAdjustmentId() {
        return getOrderAdjustmentEventId().getOrderAdjustmentId();
    }

    public void setOrderAdjustmentId(String orderAdjustmentId) {
        getOrderAdjustmentEventId().setOrderAdjustmentId(orderAdjustmentId);
    }
    ...
    protected AbstractOrderAdjustmentEvent() {
    }

    protected AbstractOrderAdjustmentEvent(OrderAdjustmentEventId eventId) {
        this.orderAdjustmentEventId = eventId;
    }
    ...
    public static abstract class AbstractOrderAdjustmentStateEvent extends AbstractOrderAdjustmentEvent implements OrderAdjustmentEvent.OrderAdjustmentStateEvent {
        ...
        protected AbstractOrderAdjustmentStateEvent(OrderAdjustmentEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractOrderAdjustmentStateCreated extends AbstractOrderAdjustmentStateEvent implements OrderAdjustmentEvent.OrderAdjustmentStateCreated
    {
        public AbstractOrderAdjustmentStateCreated() {
            this(new OrderAdjustmentEventId());
        }

        public AbstractOrderAdjustmentStateCreated(OrderAdjustmentEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractOrderAdjustmentStateMergePatched extends AbstractOrderAdjustmentStateEvent implements OrderAdjustmentEvent.OrderAdjustmentStateMergePatched
    {
        public AbstractOrderAdjustmentStateMergePatched() {
            this(new OrderAdjustmentEventId());
        }

        public AbstractOrderAdjustmentStateMergePatched(OrderAdjustmentEventId eventId) {
            super(eventId);
        }
    ...
    {
        public SimpleOrderAdjustmentStateCreated() {
        }

        public SimpleOrderAdjustmentStateCreated(OrderAdjustmentEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleOrderAdjustmentStateMergePatched extends AbstractOrderAdjustmentStateMergePatched
    {
        public SimpleOrderAdjustmentStateMergePatched() {
        }
