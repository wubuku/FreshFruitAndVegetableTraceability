...
public class ProductGoodIdentificationId implements Serializable {
    ...
    public boolean equals(Object obj)
    {
        ...
        ProductGoodIdentificationId other = (ProductGoodIdentificationId)obj;
        return true 
            && (productId == other.productId || (productId != null && productId.equals(other.productId)))
            && (goodIdentificationTypeId == other.goodIdentificationTypeId || (goodIdentificationTypeId != null && goodIdentificationTypeId.equals(other.goodIdentificationTypeId)))
            ;
    }
    ...
    public int hashCode()
    {
        ...
        if (this.goodIdentificationTypeId != null) {
            hash += 13 * this.goodIdentificationTypeId.hashCode();
        }
        return hash;
    }
    ...
    public String toString() {
        return "ProductGoodIdentificationId{" +
                "productId=" + '\'' + productId + '\'' +
