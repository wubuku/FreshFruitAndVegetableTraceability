...
public class CommentEventId implements Serializable {
    ...
    public void setArticleVersion(Long articleVersion)
    {
    ...
    public CommentEventId(Long articleId, Long commentSeqId, Long articleVersion)
    {
        this.articleId = articleId;
        this.commentSeqId = commentSeqId;
        this.articleVersion = articleVersion;
    ...
    public boolean equals(Object obj)
    {
        ...
        return true 
            ...
            && (articleVersion == other.articleVersion || (articleVersion != null && articleVersion.equals(other.articleVersion)))
            ;
    }
    ...
    public int hashCode()
    {
        ...
        if (this.articleVersion != null) {
            hash += 13 * this.articleVersion.hashCode();
        }
        return hash;
    }
