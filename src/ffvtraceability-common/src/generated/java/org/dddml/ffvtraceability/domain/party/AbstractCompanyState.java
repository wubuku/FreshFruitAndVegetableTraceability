...
import org.dddml.ffvtraceability.domain.party.CompanyEvent.*;

public abstract class AbstractCompanyState extends AbstractLegalOrganizationState implements CompanyState.SqlCompanyState, Saveable {

    public AbstractCompanyState(List<Event> events) {
    ...
    public void mutate(Event e) {
        ...
        if (e instanceof CompanyStateCreated) {
    ...
    public void when(CompanyStateCreated e) {
        throwOnWrongEvent(e);
    ...
    public void merge(PartyState s) {
        merge((CompanyState)s);
    }

    public void merge(CompanyState s) {
        if (s == this) {
            return;
        }
    ...
    public void when(CompanyStateMergePatched e) {
        throwOnWrongEvent(e);
    ...
    public static class SimpleCompanyState extends AbstractCompanyState {

        public SimpleCompanyState() {
        }

        public SimpleCompanyState(List<Event> events) {
            super(events);
        }

        public static SimpleCompanyState newForReapplying() {
            SimpleCompanyState s = new SimpleCompanyState();
