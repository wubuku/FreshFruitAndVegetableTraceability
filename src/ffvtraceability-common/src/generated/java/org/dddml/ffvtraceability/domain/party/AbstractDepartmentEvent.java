...
public abstract class AbstractDepartmentEvent extends AbstractOrganizationEvent implements OrganizationEvent {
    protected AbstractDepartmentEvent() {
    }

    protected AbstractDepartmentEvent(PartyEventId eventId) {
        super(eventId);
    }
    ...
    public static abstract class AbstractDepartmentStateEvent extends AbstractOrganizationStateEvent implements DepartmentEvent.DepartmentStateEvent {
        protected AbstractDepartmentStateEvent(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractDepartmentStateCreated extends AbstractDepartmentStateEvent implements DepartmentEvent.DepartmentStateCreated, Saveable
    {
        public AbstractDepartmentStateCreated() {
            this(new PartyEventId());
        }

        public AbstractDepartmentStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractDepartmentStateMergePatched extends AbstractDepartmentStateEvent implements DepartmentEvent.DepartmentStateMergePatched, Saveable
    {
        public AbstractDepartmentStateMergePatched() {
            this(new PartyEventId());
        }

        public AbstractDepartmentStateMergePatched(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractDepartmentStateDeleted extends AbstractDepartmentStateEvent implements DepartmentEvent.DepartmentStateDeleted, Saveable
    {
        public AbstractDepartmentStateDeleted() {
            this(new PartyEventId());
        }

        public AbstractDepartmentStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimpleDepartmentStateCreated extends AbstractDepartmentStateCreated
    {
        public SimpleDepartmentStateCreated() {
        }

        public SimpleDepartmentStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleDepartmentStateMergePatched extends AbstractDepartmentStateMergePatched
    {
        public SimpleDepartmentStateMergePatched() {
        }

        public SimpleDepartmentStateMergePatched(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleDepartmentStateDeleted extends AbstractDepartmentStateDeleted
    {
        public SimpleDepartmentStateDeleted() {
        }

        public SimpleDepartmentStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
    }
