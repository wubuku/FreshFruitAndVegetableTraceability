...
public abstract class AbstractLegalOrganizationEvent extends AbstractOrganizationEvent implements OrganizationEvent {
    ...
    public static abstract class AbstractLegalOrganizationStateDeleted extends AbstractLegalOrganizationStateEvent implements LegalOrganizationEvent.LegalOrganizationStateDeleted, Saveable
    {
        public AbstractLegalOrganizationStateDeleted() {
            this(new PartyEventId());
        }

        public AbstractLegalOrganizationStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimpleLegalOrganizationStateDeleted extends AbstractLegalOrganizationStateDeleted
    {
        public SimpleLegalOrganizationStateDeleted() {
        }

        public SimpleLegalOrganizationStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
    }
