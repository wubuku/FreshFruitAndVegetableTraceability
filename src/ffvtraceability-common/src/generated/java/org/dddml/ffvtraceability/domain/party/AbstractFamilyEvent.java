...
public abstract class AbstractFamilyEvent extends AbstractInformalOrganizationEvent implements InformalOrganizationEvent {
    protected AbstractFamilyEvent() {
    }

    protected AbstractFamilyEvent(PartyEventId eventId) {
        super(eventId);
    }
    ...
    public static abstract class AbstractFamilyStateEvent extends AbstractInformalOrganizationStateEvent implements FamilyEvent.FamilyStateEvent {
        ...
        protected AbstractFamilyStateEvent(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractFamilyStateCreated extends AbstractFamilyStateEvent implements FamilyEvent.FamilyStateCreated, Saveable
    {
        public AbstractFamilyStateCreated() {
            this(new PartyEventId());
        }

        public AbstractFamilyStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractFamilyStateMergePatched extends AbstractFamilyStateEvent implements FamilyEvent.FamilyStateMergePatched, Saveable
    {
        public AbstractFamilyStateMergePatched() {
            this(new PartyEventId());
        }

        public AbstractFamilyStateMergePatched(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractFamilyStateDeleted extends AbstractFamilyStateEvent implements FamilyEvent.FamilyStateDeleted, Saveable
    {
        public AbstractFamilyStateDeleted() {
            this(new PartyEventId());
        }

        public AbstractFamilyStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static class SimpleFamilyStateCreated extends AbstractFamilyStateCreated
    {
        public SimpleFamilyStateCreated() {
        }

        public SimpleFamilyStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleFamilyStateMergePatched extends AbstractFamilyStateMergePatched
    {
        public SimpleFamilyStateMergePatched() {
        }

        public SimpleFamilyStateMergePatched(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleFamilyStateDeleted extends AbstractFamilyStateDeleted
    {
        public SimpleFamilyStateDeleted() {
        }

        public SimpleFamilyStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
    }
