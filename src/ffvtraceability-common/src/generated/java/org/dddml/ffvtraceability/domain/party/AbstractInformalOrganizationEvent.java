...
public abstract class AbstractInformalOrganizationEvent extends AbstractOrganizationEvent implements OrganizationEvent {
    protected AbstractInformalOrganizationEvent() {
    }

    protected AbstractInformalOrganizationEvent(PartyEventId eventId) {
        super(eventId);
    }
    ...
    public static abstract class AbstractInformalOrganizationStateEvent extends AbstractOrganizationStateEvent implements InformalOrganizationEvent.InformalOrganizationStateEvent {
        protected AbstractInformalOrganizationStateEvent(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractInformalOrganizationStateCreated extends AbstractInformalOrganizationStateEvent implements InformalOrganizationEvent.InformalOrganizationStateCreated, Saveable
    {
        public AbstractInformalOrganizationStateCreated() {
            this(new PartyEventId());
        }

        public AbstractInformalOrganizationStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractInformalOrganizationStateMergePatched extends AbstractInformalOrganizationStateEvent implements InformalOrganizationEvent.InformalOrganizationStateMergePatched, Saveable
    {
        public AbstractInformalOrganizationStateMergePatched() {
            this(new PartyEventId());
        }

        public AbstractInformalOrganizationStateMergePatched(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractInformalOrganizationStateDeleted extends AbstractInformalOrganizationStateEvent implements InformalOrganizationEvent.InformalOrganizationStateDeleted, Saveable
    {
        public AbstractInformalOrganizationStateDeleted() {
            this(new PartyEventId());
        }

        public AbstractInformalOrganizationStateDeleted(PartyEventId eventId) {
            super(eventId);
        }
