...
public abstract class AbstractCompanyEvent extends AbstractLegalOrganizationEvent implements LegalOrganizationEvent {
    protected AbstractCompanyEvent() {
    }

    protected AbstractCompanyEvent(PartyEventId eventId) {
        super(eventId);
    }
    ...
    public static abstract class AbstractCompanyStateEvent extends AbstractLegalOrganizationStateEvent implements CompanyEvent.CompanyStateEvent {
        protected AbstractCompanyStateEvent(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static abstract class AbstractCompanyStateCreated extends AbstractCompanyStateEvent implements CompanyEvent.CompanyStateCreated, Saveable
    {
        public AbstractCompanyStateCreated() {
            this(new PartyEventId());
        }

        public AbstractCompanyStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    ...
    public static abstract class AbstractCompanyStateMergePatched extends AbstractCompanyStateEvent implements CompanyEvent.CompanyStateMergePatched, Saveable
    {
        public AbstractCompanyStateMergePatched() {
            this(new PartyEventId());
        }

        public AbstractCompanyStateMergePatched(PartyEventId eventId) {
            super(eventId);
        }
    ...
    {
        public SimpleCompanyStateCreated() {
        }

        public SimpleCompanyStateCreated(PartyEventId eventId) {
            super(eventId);
        }
    }

    public static class SimpleCompanyStateMergePatched extends AbstractCompanyStateMergePatched
    {
        public SimpleCompanyStateMergePatched() {
        }
