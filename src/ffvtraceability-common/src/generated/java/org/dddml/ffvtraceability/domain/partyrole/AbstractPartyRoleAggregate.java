...
public abstract class AbstractPartyRoleAggregate extends AbstractAggregate implements PartyRoleAggregate {
    ...
    protected PartyRoleEvent map(PartyRoleCommand.CreatePartyRole c) {
        ...
        e.setShippingAddress(c.getShippingAddress());
        e.setPaymentMethodEnumId(c.getPaymentMethodEnumId());
        e.setCreditRating(c.getCreditRating());
    ...
    protected PartyRoleEvent map(PartyRoleCommand.MergePatchPartyRole c) {
        ...
        e.setIsPropertyShippingAddressRemoved(c.getIsPropertyShippingAddressRemoved());
        e.setIsPropertyPaymentMethodEnumIdRemoved(c.getIsPropertyPaymentMethodEnumIdRemoved());
        e.setIsPropertyCreditRatingRemoved(c.getIsPropertyCreditRatingRemoved());
