...
import org.dddml.ffvtraceability.domain.party.OrganizationEvent.*;

public abstract class AbstractOrganizationState extends AbstractPartyState implements OrganizationState.SqlOrganizationState, Saveable {
    ...
    public void merge(OrganizationState s) {
        if (s == this) {
            return;
        }
    ...
    public static class SimpleOrganizationState extends AbstractOrganizationState {
        ...
        public static SimpleOrganizationState newForReapplying() {
            SimpleOrganizationState s = new SimpleOrganizationState();
