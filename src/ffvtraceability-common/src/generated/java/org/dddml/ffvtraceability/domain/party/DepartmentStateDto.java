...
public class DepartmentStateDto extends OrganizationStateDto {
    ...
    public static class DtoConverter extends AbstractStateDtoConverter
    {
        ...
        public DepartmentStateDto[] toDepartmentStateDtoArray(Iterable<PartyState> states) {
            return toDepartmentStateDtoList(states).toArray(new DepartmentStateDto[0]);
        }

        public List<DepartmentStateDto> toDepartmentStateDtoList(Iterable<PartyState> states) {
            ArrayList<DepartmentStateDto> stateDtos = new ArrayList();
            for (PartyState s : states) {
                DepartmentStateDto dto = toDepartmentStateDto(s);
                stateDtos.add(dto);
            }
            return stateDtos;
        }

        public DepartmentStateDto toDepartmentStateDto(PartyState state)
        {
            if(state == null) {
                return null;
            }
