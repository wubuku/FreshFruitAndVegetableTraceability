...
public class BffSalesOrderFulfillmentDto implements Serializable {
    ...
    public BffSalesOrderFulfillmentDto()
    {
    }

    public BffSalesOrderFulfillmentDto(String receiptId, String shipmentId, java.math.BigDecimal allocatedQuantity, OffsetDateTime receivedAt, String shipmentQaStatusId, String shipmentQaInspectionStatusId, String shipmentStatusId)
    {
        this.receiptId = receiptId;
        this.shipmentId = shipmentId;
        this.allocatedQuantity = allocatedQuantity;
    ...
    public boolean equals(Object obj)
    {
        ...
        BffSalesOrderFulfillmentDto other = (BffSalesOrderFulfillmentDto)obj;
        return true 
    ...
    public String toString() {
        return "BffSalesOrderFulfillmentDto{" +
                "receiptId=" + '\'' + receiptId + '\'' +
