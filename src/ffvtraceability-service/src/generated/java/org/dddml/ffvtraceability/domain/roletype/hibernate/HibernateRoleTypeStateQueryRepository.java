...
public class HibernateRoleTypeStateQueryRepository implements RoleTypeStateQueryRepository {
    ...
    public RoleTypeState get(String id) {
        RoleTypeState state = (RoleTypeState)getEntityManager().find(AbstractRoleTypeState.SimpleRoleTypeState.class, id);
        return state;
    }
    ...
    public Iterable<RoleTypeState> getAll(Integer firstResult, Integer maxResults) {
        ...
        CriteriaQuery<AbstractRoleTypeState.SimpleRoleTypeState> cq = cb.createQuery(AbstractRoleTypeState.SimpleRoleTypeState.class);
        Root<AbstractRoleTypeState.SimpleRoleTypeState> root = cq.from(AbstractRoleTypeState.SimpleRoleTypeState.class);
        cq.select(root);
        addNotDeletedRestriction(cb, cq, root);
        TypedQuery<AbstractRoleTypeState.SimpleRoleTypeState> query = em.createQuery(cq);
        JpaUtils.applyPagination(query, firstResult, maxResults);
        return query.getResultList().stream().map(RoleTypeState.class::cast).collect(Collectors.toList());
    }
