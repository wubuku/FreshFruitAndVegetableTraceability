...
public class AggregatesHibernateConfig {
    ...
    @Bean
    public AbstractPhysicalInventoryApplicationService.SimplePhysicalInventoryApplicationService physicalInventoryApplicationService(
            @Qualifier("physicalInventoryEventStore") EventStore physicalInventoryEventStore,
            PhysicalInventoryStateRepository physicalInventoryStateRepository,
            PhysicalInventoryStateQueryRepository physicalInventoryStateQueryRepository
    ) {
        AbstractPhysicalInventoryApplicationService.SimplePhysicalInventoryApplicationService applicationService = new AbstractPhysicalInventoryApplicationService.SimplePhysicalInventoryApplicationService(
                physicalInventoryEventStore,
                physicalInventoryStateRepository,
                physicalInventoryStateQueryRepository
        );
        return applicationService;
    }
    ...
    @Bean
    public AbstractVarianceReasonApplicationService.SimpleVarianceReasonApplicationService varianceReasonApplicationService(
            VarianceReasonStateRepository varianceReasonStateRepository,
            VarianceReasonStateQueryRepository varianceReasonStateQueryRepository
    ) {
        AbstractVarianceReasonApplicationService.SimpleVarianceReasonApplicationService applicationService = new AbstractVarianceReasonApplicationService.SimpleVarianceReasonApplicationService(
                varianceReasonStateRepository,
                varianceReasonStateQueryRepository
        );
        return applicationService;
    }
