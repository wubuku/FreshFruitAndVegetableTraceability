...
public class HibernateOrganizationStateQueryRepository implements OrganizationStateQueryRepository {
    ...
    public OrganizationState get(String id) {
        OrganizationState state = (OrganizationState)getEntityManager().find(AbstractOrganizationState.SimpleOrganizationState.class, id);
        return state;
    }
    ...
    public Iterable<OrganizationState> getAll(Integer firstResult, Integer maxResults) {
        ...
        CriteriaQuery<AbstractOrganizationState.SimpleOrganizationState> cq = cb.createQuery(AbstractOrganizationState.SimpleOrganizationState.class);
        Root<AbstractOrganizationState.SimpleOrganizationState> root = cq.from(AbstractOrganizationState.SimpleOrganizationState.class);
        cq.select(root);
        addNotDeletedRestriction(cb, cq, root);
        TypedQuery<AbstractOrganizationState.SimpleOrganizationState> query = em.createQuery(cq);
        JpaUtils.applyPagination(query, firstResult, maxResults);
        return query.getResultList().stream().map(OrganizationState.class::cast).collect(Collectors.toList());
    }
