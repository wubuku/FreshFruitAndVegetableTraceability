...
public interface BffCustomerRepository extends JpaRepository<AbstractPartyState, String> {
    @Query(value = """
            SELECT 
                ...
                pr.payment_method_enum_id as paymentMethodEnumId,
                pr.shipping_address as shippingAddress,
                pr.credit_rating as creditRating,
            ...
            countQuery = """
                    ...
                    """,
            nativeQuery = true)
    Page<BffCustomerProjection> findAllCustomers(Pageable pageable, @Param("statusId") String statusId);
